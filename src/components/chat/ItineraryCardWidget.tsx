        ...
        {itinerary.map((dayPlan) => (
          <div key={dayPlan.day} className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <span className="bg-blue-600 text-white text-2xs font-bold px-2 py-0.5 rounded-md">
                Ngày {dayPlan.day}
              </span>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 p-3 space-y-3 shadow-xs">
              {dayPlan.activities.map((act, index) => (
                ...
                >
                  {/* Time*/}
                  <div className="flex items-center gap-1 text-xxs font-bold text-blue-600 shrink-0 mt-0.5 w-18">
                  ...
                  <div className="flex-1 min-w-0 space-y-0.5">
                    <h6 className="text-xs font-bold text-brand-dark truncate">
                      {act.title}
                    </h6>
