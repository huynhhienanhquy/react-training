...
export const ChatHistorySidebar = ({
  ...
  // 2. Automatically group conversations by the group field.
  // Default is TODAY if not assigned.
      ...
      <div className="px-6 pt-12 pb-2">
        ...
        <div className="relative pt-7">
          <SearchIcon
            ...
            color="#94A3B8"
            aria-hidden="true"
            className="absolute left-4 top-[calc(50%+14px)] -translate-y-1/2 pointer-events-none"
          />
