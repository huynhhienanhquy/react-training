  ...
  return (
    <div className="my-auto flex w-full flex-1 flex-col items-center justify-center px-1 py-5 text-center md:-translate-y-10 md:px-4 md:py-6 lg:translate-y-5 desktop:absolute desktop:inset-x-0 desktop:top-127 desktop:my-0 desktop:flex-none desktop:translate-y-0 desktop:py-0">
      ...
      <div className="mb-4 flex items-center justify-center -space-x-3 md:mb-6 lg:mb-5 desktop:mb-5">
        ...
        <div className="w-20 h-20 md:w-24 md:h-24 lg:w-26 lg:h-26 desktop:h-24 desktop:w-24 rounded-2xl overflow-hidden border-3 border-white shadow-md z-20">
          <img
        ...
        <div className="w-20 h-20 md:w-24 md:h-24 lg:w-26 lg:h-26 desktop:h-24 desktop:w-24 rounded-2xl overflow-hidden border-3 border-white shadow-md z-30">
          <img
      ...
      {/* Main Title */}
      <h2 className="mb-5 text-2xl font-bold tracking-tight text-ink-deep md:mb-8 md:text-4xl lg:text-display-title desktop:mb-11">
        {'Let\u2019s Plan Your Next Adventure'}
      </h2>

      {/* Prompts Section  */}
      <div className="mb-4 flex w-full max-w-4xl flex-col items-center gap-2 sm:gap-3 md:mb-8 lg:max-w-6xl lg:gap-5 desktop:gap-4">
        <div className="flex flex-wrap justify-center gap-2 sm:gap-3 lg:gap-5 desktop:gap-4">
