...
export const StartNewChatButton: React.FC<StartNewChatButtonProps> = ({
  ...
  return (
    <button
      onClick={onClick}
      className={`flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-xl shadow-sm transition active:scale-95 ${className}`}
    >
