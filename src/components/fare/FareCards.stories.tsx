...
// 1. Story mặc định chọn hạng Economy (Stateless view)
...
// 2. Story mặc định chọn hạng Business (Stateless view)
...
// 3. Interactive Story (Có thể bấm click đổi lựa chọn trực tiếp)
