...
vi.mock('@/components/common/Chat/ChatHistorySidebar', () => ({
  ChatHistorySidebar: ({
    sessions,
    onSelectSession,
  }: {
...
vi.mock('@/components/common/Chat/WelcomeState', () => ({
  WelcomeState: ({
    onSelectPrompt,
  }: {
...
vi.mock('@/components/common/Chat/ChatMessageList', () => ({
  ChatMessageList: ({
    messages,
    onBookFlight,
    onBookHotel,
...
vi.mock('@/components/common/Chat/ChatInputBox/ChatInputBox', () => ({
  ChatInputBox: ({
    onSend,
  }: {
    onSend: () => void;
